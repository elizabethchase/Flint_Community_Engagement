...
exam <- select(child_adult, child, unique_id, relationship, age.x, gender.x, public_benefits, gettested, elevbll, rash, hair, learn, hyper, irritable, overall_symp, racecollapse, blood_test_after_april_2014, water_exaggerated)
...
##summary(watersource_model)

#For getting tested:
tested_model_noadult <- glmer(gettested ~ gender.x + age.x + racecollapse + pubben + (1 | unique_id), data = child_adult, family = "binomial")
tested_model_adult <- glmer(gettested ~ gender.x + age.x + racecollapse + pubben + water_exaggeratedbinary + (1 | unique_id), data = child_adult, family = "binomial")

summary(tested_model_noadult)
summary(tested_model_adult)

effects_mat <- data.frame("Outcome" = rep("Get tested", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Water crisis was exaggerated (ref: Crisis not exaggerated)"), "Estimate" = c(summary(tested_model_noadult)$coefficients[-1,1], summary(tested_model_adult)$coefficients[7,1]), "StErr" = c(summary(tested_model_noadult)$coefficients[-1,2], summary(tested_model_adult)$coefficients[7,2]), "Pvalue" = c(summary(tested_model_noadult)$coefficients[-1,4], summary(tested_model_adult)$coefficients[7,4]))
...
#bll_model_adult <- glmer(elevbll ~ gender.x + scale(age.x) + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial") # Not included due to convergence issues

#summary(bll_model_noadult)
#summary(bll_model_adult)
  
#subdat <- data.frame("Outcome" = rep("Elevated BLLs", 5), "Variable" = c("Gender", "Age", "Race-Other", "Race-White", "Public Benefits"), "Estimate" = c(summary(bll_model_noadult)$coefficients[-1,1]), "StErr" = c(summary(bll_model_noadult)$coefficients[-1,2]), "Pvalue" = c(summary(bll_model_noadult)$coefficients[-1,4]))
...
summary(rash_model_noadult)
rash_model_adult <- glmer(rash ~ gender.x + age.x + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial")
summary(rash_model_adult)

subdat <- data.frame("Outcome" = rep("Rashes", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs"), "Estimate" = c(summary(rash_model_noadult)$coefficients[-1,1], summary(rash_model_adult)$coefficients[7,1]), "StErr" = c(summary(rash_model_noadult)$coefficients[-1,2], summary(rash_model_adult)$coefficients[7,2]), "Pvalue" = c(summary(rash_model_noadult)$coefficients[-1,4], summary(rash_model_adult)$coefficients[7,4]))

effects_mat <- rbind(effects_mat, subdat)

#For having hair loss:
#hair_model_noadult <- glmer(hair ~ gender.x + scale(age.x) + racecollapse + pubben + (1 | unique_id), data = child_adult, family = "binomial") ## convergence issues; did not include
#summary(hair_model_noadult)
#hair_model_adult <- glmer(hair ~ gender.x + scale(age.x) + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial") ## convergence issues; did not include
#summary(hair_model_adult)

#subdat <- data.frame("Outcome" = rep("Hairloss", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs"), "Estimate" = c(summary(hair_model_noadult)$coefficients[-1,1], summary(hair_model_adult)$coefficients[7,1]), "StErr" = c(summary(hair_model_noadult)$coefficients[-1,2], summary(hair_model_adult)$coefficients[7,2]), "Pvalue" = c(summary(hair_model_noadult)$coefficients[-1,4], summary(hair_model_adult)$coefficients[7,4]))
...
summary(learn_model_noadult)

learn_model_layer2 <- glmer(learn ~ gender.x + age.x + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial")
summary(learn_model_layer2)

subdat <- data.frame("Outcome" = rep("Learning Delays", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs"), "Estimate" = c(summary(learn_model_noadult)$coefficients[-1,1], summary(learn_model_layer2)$coefficients[7,1]), "StErr" = c(summary(learn_model_noadult)$coefficients[-1,2], summary(learn_model_layer2)$coefficients[7,2]), "Pvalue" = c(summary(learn_model_noadult)$coefficients[-1,4], summary(learn_model_layer2)$coefficients[7,4]))

effects_mat <- rbind(effects_mat, subdat)

#For having hyperactivity:
hyper_model_noadult <- glmer(hyper ~ gender.x + scale(age.x) + racecollapse + pubben + (1 | unique_id), data = child_adult, family = "binomial")
summary(hyper_model_noadult)

hyper_model_layer2 <- glmer(hyper ~ gender.x + age.x + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial")
summary(hyper_model_layer2)

subdat <- data.frame("Outcome" = rep("Hyperactivity", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs"), "Estimate" = c(summary(hyper_model_noadult)$coefficients[-1,1], summary(hyper_model_layer2)$coefficients[7,1]), "StErr" = c(summary(hyper_model_noadult)$coefficients[-1,2], summary(hyper_model_layer2)$coefficients[7,2]), "Pvalue" = c(summary(hyper_model_noadult)$coefficients[-1,4], summary(hyper_model_layer2)$coefficients[7,4]))
...
summary(irr_model_noadult)
irr_model_adult <- glmer(irritable ~ gender.x + age.x + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + (1 | unique_id), data = child_adult, family = "binomial")
summary(irr_model_adult)

subdat <- data.frame("Outcome" = rep("Irritability", 6), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs"), "Estimate" = c(summary(irr_model_noadult)$coefficients[-1,1], summary(irr_model_adult)$coefficients[7,1]), "StErr" = c(summary(irr_model_noadult)$coefficients[-1,2], summary(irr_model_adult)$coefficients[7,2]), "Pvalue" = c(summary(irr_model_noadult)$coefficients[-1,4], summary(irr_model_adult)$coefficients[7,4]))

effects_mat <- rbind(effects_mat, subdat)

#For overall symptoms:
overall_model_noadult <- lmer(overall_symp ~ gender.x + age.x + racecollapse + pubben + (1 | unique_id), data = child_adult)
summary(overall_model_noadult)

overall_model_adult <- lmer(overall_symp ~ gender.x + age.x + racecollapse + pubben + as.numeric(blood_test_after_april_2014=="Yes") + water_exaggeratedbinary + (1 | unique_id), data = child_adult)
summary(overall_model_adult)

subdat <- data.frame("Outcome" = rep("Overall Symptoms", 7), "Variable" = c("Male gender (ref: Female gender)", "Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Receives public benefits (ref: No benefits)", "Child screened for BLLs (ref: Child not screened for BLLs)", "Water crisis was exaggerated (ref: Crisis not exaggerated)"), "Estimate" = c(summary(overall_model_noadult)$coefficients[-1,1], summary(overall_model_adult)$coefficients[7:8,1]), "StErr" = c(summary(overall_model_noadult)$coefficients[-1,2], summary(overall_model_adult)$coefficients[7:8,2]), "Pvalue" = pnorm(c(summary(overall_model_noadult)$coefficients[-1,3], summary(overall_model_adult)$coefficients[7:8,3]), lower.tail = FALSE))
...
pretty_effects$BHpvalue <- round(pretty_effects$BHpvalue, 3)
rownames(pretty_effects) <- NULL

kable(pretty_effects, col.names = c("Outcome", "Predictor", "Odds Ratio (95% CI)", "P-value"))
```

Note that these modeling results doesn't include one important outcomes: child water source. I was unable to get this model to fit stably because of the small number of children not drinking bottled water. In addition, I couldn't consider the effect of the caregiver believing the water crisis was exaggerated on most of the outcomes because of convergence issues, and similarly with the relationship between the child being tested and the child having elevated BLLs.
