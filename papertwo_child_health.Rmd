...
This analysis was redone using GEE, in order to meet a reviewer request for a non-Bayesian analysis and to deal with the large number of small clusters in the data.
