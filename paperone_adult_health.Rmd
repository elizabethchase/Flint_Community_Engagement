...
#kable(print(table_predictors, contDigits=1, varLabel = T, printToggle=FALSE), booktabs=T) %>% add_indent(c(4:6, 8:12, 14:16, 18:20)) %>% kable_styling(position="center")
...
#kable(print(table_predictors_notstrat, contDigits=1, varLabel = T, printToggle=FALSE), booktabs=T) %>% add_indent(c(4:6, 8:12, 14:16, 18:20)) %>% kable_styling(position="center")
...
#bloodlead_dem <- with(imp_long_mids, logistf(elevated_collapse ~ age + collapsegender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2))

#bloodlead_dem <- lapply(1:5, function(X) logistf(data = select(list_imps[[X]], elevated_collapse, age, collapsegender, collapserace, collapsepubben, number_children, years_cityflint, confidants2, zip2), elevated_collapse ~ age + collapsegender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2, pl = TRUE, dataout = TRUE))
...
#test <- CLIP.confint(obj = bloodlead_dem)
...
#rash_symp <- logistf(rash_collapse ~ age + gender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2 + hair_collapse + nausea_collapse + irritable_collapse + elevated_collapse + bloodtest_collapse + num_time_notice + rash_collapse_before, data=mydata_complete)
...
#hairloss_symp <- logistf(hair_collapse ~ age + gender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2 + rash_collapse + nausea_collapse + irritable_collapse + elevated_collapse + bloodtest_collapse + num_time_notice + hair_collapse_before, data=mydata_complete)
...
#nausea_symp <- logistf(nausea_collapse ~ age + gender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2 + rash_collapse + hair_collapse + irritable_collapse + elevated_collapse + bloodtest_collapse + num_time_notice + nausea_collapse_before, data=mydata_complete)
...
#irritable_symp <- logistf(irritable_collapse ~ age + gender + collapserace + collapsepubben + number_children + years_cityflint + confidants2 + zip2 + rash_collapse + hair_collapse + nausea_collapse + elevated_collapse + bloodtest_collapse + num_time_notice + irritable_collapse_before, data=mydata_complete)
