...
subdat <- data.frame("Outcome" = rep("The water source switch was intended to harm Flint residents.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(intent_model_layer1)$coefficients[1:14, 1], summary(intent_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(intent_model_layer1)$coefficients[1:14, 2], summary(intent_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("People have made the water issues a bigger deal than reality.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(exag_model_layer1)$coefficients[1:14, 1], summary(exag_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(exag_model_layer1)$coefficients[1:14, 2], summary(exag_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("Children in Flint are going to have health problems in future due to the water crisis.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(harm_model_layer1)$coefficients[1:14, 1], summary(harm_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(harm_model_layer1)$coefficients[1:14, 2], summary(harm_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("The water source switch was discriminatory against lower income Flint residents.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(poor_model_layer1)$coefficients[1:14, 1], summary(poor_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(poor_model_layer1)$coefficients[1:14, 2], summary(poor_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("The water source switch was racially motivated.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(race_model_layer1)$coefficients[1:14, 1], summary(race_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(race_model_layer1)$coefficients[1:14, 2], summary(race_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("I am likely to trust the government on water/environmental issues in future.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(trust_model_layer1)$coefficients[1:14, 1], summary(trust_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(trust_model_layer1)$coefficients[1:14, 2], summary(trust_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("Three years from now, I am likely to drink primarily tap water at home.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(drink_model_layer1)$coefficients[1:14, 1], summary(drink_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(drink_model_layer1)$coefficients[1:14, 2], summary(drink_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("I am satisfied with the federal government's role in addressing the Flint water issues.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(fedsatis_model_layer1)$coefficients[1:14, 1], summary(fedsatis_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(fedsatis_model_layer1)$coefficients[1:14, 2], summary(fedsatis_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("I am satisfied with the Michigan government's role in addressing the Flint water issues.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(statesatis_model_layer1)$coefficients[1:14, 1], summary(statesatis_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(statesatis_model_layer1)$coefficients[1:14, 2], summary(statesatis_model_layer2)$coefficients[15:16, 2]))
...
subdat <- data.frame("Outcome" = rep("I am satisfied with the Flint government's role in addressing the Flint water issues.", 16), "Predictor" = c("Age", "Male", "Other Race", "White Race", "Receives public benefits", "Republican", "Other political party", "Years in Flint", "Number of confidants", "Zipcode 48504", "Zipcode 48505", "Zipcode 48506", "Zipcode 48507", "Zipcode 48532", "Number of adult symptoms", "Had child report at least one symptom"), "Effect" = c(summary(flintsatis_model_layer1)$coefficients[1:14, 1], summary(flintsatis_model_layer2)$coefficients[15:16, 1]), "SE" = c(summary(flintsatis_model_layer1)$coefficients[1:14, 2], summary(flintsatis_model_layer2)$coefficients[15:16, 2]))
