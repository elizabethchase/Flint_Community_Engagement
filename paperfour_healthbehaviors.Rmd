...
#mydata_complete$gender <- factor(mydata_complete$gender)
...
#mydata_complete$have_health_insurance <- factor(mydata_complete$have_health_insurance)
...
number_water_tests <- with(imp_long_mids, lm(log(watertestnum + 0.1) ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + number_children + confidants2))
...
## This model could not be fit because of small sample sizes.
#elev_blls <- with(imp_long_mids, glm(as.numeric(elevated_lead_after_april_2014=="Yes") ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + water_source2 + number_children + confidants2, family = "binomial"))

#summary(pool(elev_blls))

#subdat <- data.frame("Outcome" = rep("Elevated BLLs", 18), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Other water source (ref: Flint tap water)", "Number of children", "Network size"), "Estimate" = summary(pool(elev_blls))$estimate[-1], "SE" = summary(pool(elev_blls))$std.error[-1], "Pval" = summary(pool(elev_blls))$p.value[-1])
...
number_bottles <- with(imp_long_mids, glm(num_bottles_per_day ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + number_children + confidants2, family = "quasipoisson"))

summary(pool(number_bottles))

subdat <- data.frame("Outcome" = rep("Number of bottles per day", 22), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Number of children", "Network size"), "Estimate" = summary(pool(number_bottles))$estimate[-1], "SE" = summary(pool(number_bottles))$std.error[-1], "Pval" = summary(pool(number_bottles))$p.value[-1])

effect_estims <- rbind(effect_estims, subdat)

recycle_bottles <- with(imp_long_mids, glm(as.numeric(water_bottle_disposal=="I don't ever have plastic water bottles at home" | water_bottle_disposal=="Keep/save them for re-use or another purpose" | water_bottle_disposal=="Recycle them") ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + number_children + confidants2, family = "binomial"))

summary(pool(recycle_bottles))

subdat <- data.frame("Outcome" = rep("Bottle disposal", 22), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Number of children", "Network size"), "Estimate" = summary(pool(recycle_bottles))$estimate[-1], "SE" = summary(pool(recycle_bottles))$std.error[-1], "Pval" = summary(pool(recycle_bottles))$p.value[-1])

effect_estims <- rbind(effect_estims, subdat)

waterlinestatus <- with(imp_long_mids, glm(as.numeric(water_line_status_after_april2014=="A mailing or official said that my lead/water line did not need to be replaced" | water_line_status_after_april2014=="I was offered a lead/water line replacement but I refused it" | water_line_status_after_april2014=="My lead/water lines were replaced") ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + number_children + confidants2, family = "binomial"))

summary(pool(waterlinestatus))

subdat <- data.frame("Outcome" = rep("Water line status", 22), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Number of children", "Network size"), "Estimate" = summary(pool(waterlinestatus))$estimate[-1], "SE" = summary(pool(waterlinestatus))$std.error[-1], "Pval" = summary(pool(waterlinestatus))$p.value[-1])

effect_estims <- rbind(effect_estims, subdat)

water_line_time <- with(imp_long_mids, coxph(Surv(water_line_surv, as.numeric(waterline_replaced_eventind)-1) ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + number_children + confidants2))

summary(pool(water_line_time))

subdat <- data.frame("Outcome" = rep("Time to water line replacement", 22), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Number of children", "Network size"), "Estimate" = summary(pool(water_line_time))$estimate, "SE" = summary(pool(water_line_time))$std.error, "Pval" = summary(pool(water_line_time))$p.value)
...
#child_test <- with(imp_long_mids, glm(testpost2014_child ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + confidants2 + factor(blood_test_after_april_2014, ordered = FALSE) + offset(number_children), family = "quasipoisson"))

#summary(pool(child_test))

#subdat <- data.frame("Outcome" = rep("Got child tested", 23), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Network size", "Adult not tested (ref: Adult tested)", "Adult unsure if tested (ref: Adult tested)"), "Estimate" = summary(pool(child_test))$estimate[-1], "SE" = summary(pool(child_test))$std.error[-1], "Pval" = summary(pool(child_test))$p.value[-1])

#effect_estims <- rbind(effect_estims, subdat)

##This model not included because of stability issues:

#child_bll <- with(imp_long_mids, glm(bllpost2014_child ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + confidants2 + as.numeric(elevated_lead_after_april_2014=="Yes") + offset(number_children), family = "quasipoisson"))

#summary(pool(child_bll))

#subdat <- data.frame("Outcome" = rep("Child had elevated BLLs", 22), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Network size", "Adult has elevated BLLs (ref: Adult has normal/unsure BLLs)"), "Estimate" = summary(pool(child_bll))$estimate[-1], "SE" = summary(pool(child_bll))$std.error[-1], "Pval" = summary(pool(child_bll))$p.value[-1])

#effect_estims <- rbind(effect_estims, subdat)

#child_bottled <- with(imp_long_mids, glm(bottledwater_child ~ age + reth2 + gender2 + educ_level2 + marital_status2 + public_benefits + have_health_insurance2 + employ_status2 + years_cityflint + current_housing2 + access_vehicle + water_source2 + confidants2 + factor(current_water_source2, ordered = FALSE) + offset(number_children), family = "quasipoisson"))

#summary(pool(child_bottled))

#subdat <- data.frame("Outcome" = rep("Child uses bottled water", 23), "Predictor" = c("Age", "Other race (ref: Black race)", "White race (ref: Black race)", "Male (ref: Female)", "Some college (ref: High school or less)", "Associate's degree or more (ref: High school or less", "Separated (ref: Married)", "Single (ref: Married)", "No public benefits (ref: Receives public benefits)", "Unsure if receives public benefits (ref: Receives public benefits)", "Health insured (ref: Uninsured)", "Other employment (ref: Employed)", "Retired (ref: Employed)", "Unemployed (ref: Employed)", "Years lived in Flint", "Rented home (ref: Owned home)", "Unstable housing (ref: Owned home)", "Other housing (ref: Owned home)", "Other water source (ref: Flint tap water)", "Has vehicle (ref: No vehicle)", "Network size", "Adult uses filtered tap water (ref: Adult uses unfiltered water)", "Adult uses bottled water (ref: Adult uses unfiltered water)"), "Estimate" = summary(pool(child_bottled))$estimate[-1], "SE" = summary(pool(child_bottled))$std.error[-1], "Pval" = summary(pool(child_bottled))$p.value[-1])
